...
> [!WARNING]
> T4 templates are obsoleted and replaced with new [`dotnet tool`](https://www.nuget.org/packages/linq2db.cli). Tool documentation could be found [here](https://linq2db.github.io/articles/CLI.html).
